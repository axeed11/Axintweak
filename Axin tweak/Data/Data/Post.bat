...
echo                    ╚═════════════════════════════════════════════════════════════════════════════════════╝
echo.
echo                                                        [ !S_GREEN!1!S_MAGENTA! ] !S_WHITE!SOFTWARE INSTALLER!S_MAGENTA!
echo.
echo                                                         [ !S_GREEN!2!S_MAGENTA! ] !S_WHITE!TOOLS!S_MAGENTA!
echo.
echo                    ╔══════════════════════════════════════════╦══════════════════════════════════════════╗
...
if "!choice!"=="1" goto APPS_MENU_CLEAR
if "!choice!"=="2" goto TOOLS_MENU_CLEAR
